...
Some weapons will show an attribute requirement (like strength or dexterity). <br/>
If you use a weapon without the attribute requirement you deal significantly less damage <br/>
You can check your attributes in /stats <br/>
...
`STRIKE` defence, you would die after two hits. A player starts with 5 hearts and raise it in `/stats`. <br/>
...
some weapons need to be assemlbed in smithing table not crafting table <br/>
...
![damage_formula](../../public/dmg_formula.png)
