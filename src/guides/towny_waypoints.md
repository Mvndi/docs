...
4. Choose who can travel to your waypoint using `/twp set open <all|neutral|allies|nation|town|none>`.
...
NOTE: You can only travel to waypoints that are 12000 blocks near the current one you are standing on.
