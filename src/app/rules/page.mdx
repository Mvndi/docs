...
**1.1 Auto place or break blocks mods are not allowed. However schematic rendering is allowed.**
...
**4.2.2 Walls must notcontain any water, lava or obsidian**

**4.2.3 Walls must not be thicker than the area which they protect**

**4.2.4 Gavity blocks in walls are allowed within reason, therefore walls that go beyond ~30 blocks in height filled with gravity blocks in that case would not be allowed**
